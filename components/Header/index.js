          ...
          <div className={`w-full h-full mb-[50px] relative md:w-[50%]`}>
            <div className={`m-2`}>
              <span
                data-aos="fade-up"
                className={
                  "py-[2px] px-[10px] bg-green-600 text-green-100 rounded-[3px] text-[12px] text-capitalize"
                }
              >
                {usersInfo.user_skill[0]}
              </span>
              <span
                data-aos="fade-up"
                className={
                  "ml-[10px] py-[2px] px-[8px] bg-green-600 text-green-100 rounded-[3px] text-[12px] text-capitalize"
                }
              >
                {usersInfo.user_skill[1]}
              </span>
              <br />
              <br />
              <h1
    ...
    <div className="fixed top-0 left-0 w-screen h-screen bg-dark-400 z-[1500] flex flex-row items-center justify-center">
      ...
      >
        ...
        >
          <h2>My Resume / CV</h2>
          <button
            className="px-3 py-1 flex flex-row items-center justify-center bg-green-300 ml-4 text-[12px] text-dark-100 font-bold rounded-[5px] scale-[.95] transition-all hover:scale-[.95]  "
            onClick={dowloadCv}
          >
            Download
          </button>
          <button
            className="px-3 py-1 flex flex-row items-center justify-center bg-red-400 ml-4 text-[12px] text-dark-100 font-bold rounded-[5px] scale-[.95] transition-all hover:scale-[.95] "
            onClick={openResume}
          >
            Close
          </button>
