...
import { projects } from "../../data/projects.json"; // Correctly importing the default export
...
function Projects() {
  ...
  useEffect(() => {
    async function fetchRepos() {
      ...
      if (cachedRepos) {
        setRepo(JSON.parse(cachedRepos));
        return;
      }
